...
import nodei from "../assets/images/icons/node.png";
import expressi from "../assets/images/icons/express.png";
import mongoi from "../assets/images/icons/mongo.png";
  ...
  return (
    <div className="border-b border-neutral-800 pb-24">
        ...
        className="flex flex-wrap items-center justify-center gap-4">
            ...
            <motion.div variants={iconVariants(3)} initial="initial" animate="animate" className="rounded-2xl border-4 border-neutral-800 p-4">
                <img src={nodei} alt="Node.js Icon" className="w-16 h-16" /> 
            </motion.div>
            ...
            <motion.div variants={iconVariants(3.5)} initial="initial" animate="animate" className="rounded-2xl border-4 border-neutral-800 p-4">
                <img src={expressi} alt="Express.js Icon" className="w-16 h-16" /> 
            </motion.div>
            ...
            <motion.div variants={iconVariants(2.8)} initial="initial" animate="animate" className="rounded-2xl border-4 border-neutral-800 p-4">
                <img src={mongoi} alt="MongoDB Icon" className="w-16 h-16" /> 
            </motion.div>
            ...
            <motion.div variants={iconVariants(2.5)} initial="initial" animate="animate" className="rounded-2xl border-4 border-neutral-800 p-4">
                <img src={sql} alt="SQL Icon" className="w-16 h-16" /> 
            </motion.div>
